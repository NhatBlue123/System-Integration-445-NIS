    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <tiles:insertDefinition name="layouts">
            <tiles:putAttribute name="body">
                ...
                <!-- Tabulator CDN -->
                <link href="https://cdn.jsdelivr.net/npm/tabulator-tables@5.4.4/dist/css/tabulator.min.css"
                    rel="stylesheet">
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", function () {
                        ...
                        var socket = new SockJS('/springapp_show/ws');
                        var stompClient = Stomp.over(socket);
                        stompClient.debug = null; // Disable debug logging

                        stompClient.connect({}, function (frame) {
                            console.log('Connected: ' + frame);
                            stompClient.subscribe('/topic/eperson', function (message) {
